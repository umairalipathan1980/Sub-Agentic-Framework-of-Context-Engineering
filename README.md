...
Clone the repo or run the setup script to create the complete framework structure:
...
```
Note: The "Example RAG" folder contains an example RAG application generated by execute-prp sub-agent. 
